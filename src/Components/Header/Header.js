...
const Header = () => {
  return (
    ...
    <div className='w-full border py-6 flex justify-around'>
        ...
        <div>
            <input className='border py-2' type="text"  placeholder='search' name="" value=""/>
          </div>
          <div className='flex'>
            <p>one</p>
            <p>one</p>
